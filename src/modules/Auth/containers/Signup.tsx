...
export function Signup(props: RouterProps) {
    console.log('Signup');
    const { history } = props
    const [signUpState, setSignUpState] = React.useState({ email : '', password : '', error : '', salutation : '',  first_name : '',  middle_name : '',  last_name : '',  address_line_1 : '',  address_line_2 : '',  city : '',  state : '',  country : '',  pincode : '',  phone_number : '',  secondary_phone : '', recoveryAnswer : '', passwordconfirm : '', role_name : ''});
    ...
    return (
        <Flex direction="column" align="center" height="100%" pt="5vh">
            ...
            <Flex direction="column" border="1px solid #d5d5d5" p="max(2vmax, 15px)" borderRadius="15">
                <Select name="role_name" onChange={onChange} placeholder="Sign Up As" mb={1}>
                ...
                <>        
                    ...
                    <Input placeholder="First Name" name="first_name" onChange={onChange} value={signUpState.first_name} mb={1} />
                    <Input placeholder="Middle Name" name="middle_name" onChange={onChange} value={signUpState.middle_name} mb={1} />
                    <Input placeholder="Last Name" name="last_name" onChange={onChange} value={signUpState.last_name} mb={1} />
                    <Input placeholder="Address Line 1" name="address_line_1" onChange={onChange} value={signUpState.address_line_1} mb={1} />
                    <Input placeholder="Address Line 2 (Optional)" name="address_line_2" onChange={onChange} value={signUpState.address_line_2} mb={1} />
